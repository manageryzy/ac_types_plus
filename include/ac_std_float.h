...
#define __AC_DATA_PRIVATE private:
  ...
  namespace ac_private {
    ...
    CUDA_CALLABLE_MEMBER void check_supported() {
    ...
    template<ac_q_mode Q>
    CUDA_CALLABLE_MEMBER void check_supported2() {
#ifdef AC_IEEE_FLOAT_USE_BUILTIN
    ...
    struct LeadingSignConstrained {
      ...
      CUDA_CALLABLE_MEMBER static unsigned val(const ac_int<W, S>& x, bool& all_sign) {
...
#endif
    template<int MaxLShift, int W, bool S>
    CUDA_CALLABLE_MEMBER unsigned leading_sign_constrained(const ac_int<W, S>& x, bool& all_sign) {
...
#pragma hls_ccore_type sequential
#endif
    template<int W>
    CUDA_CALLABLE_MEMBER void fx_div(ac_int<W, false> const& op1, ac_int<W, false> const& op2, ac_int<W + 2, false>& quotient, bool& exact) {
    ...
    template<int W>
    CUDA_CALLABLE_MEMBER void fx_div_sim(ac_int<W, false> op1, ac_int<W, false> op2, ac_int<W + 2, false>& quotient, bool& exact) {
...
#pragma hls_ccore_type sequential
    ...
    CUDA_CALLABLE_MEMBER bool fx_sqrt(ac_int<W, false> x, ac_int<WR, false>& sqrt) {
...
namespace __AC_NAMESPACE {
  ...
  namespace ac {
    CUDA_CALLABLE_MEMBER inline void copy_bits(float a, float* b) { *b = a; }
    CUDA_CALLABLE_MEMBER inline void copy_bits(double a, double* b) { *b = a; }

    CUDA_CALLABLE_MEMBER inline void copy_bits(short a, short* b) { *b = a; }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_int<16, true>& a, short* b) { *b = (short)a.to_int(); }
    CUDA_CALLABLE_MEMBER inline void copy_bits(short a, ac_int<16, true>* b) { *b = ac_int<16, true>(a); }
    CUDA_CALLABLE_MEMBER inline void copy_bits(int a, int* b) { *b = a; }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_int<32, true>& a, int* b) { *b = a.to_int(); }
    CUDA_CALLABLE_MEMBER inline void copy_bits(int a, ac_int<32, true>* b) { *b = ac_int<32, true>(a); }
    CUDA_CALLABLE_MEMBER inline void copy_bits(long long a, long long* b) { *b = a; }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_int<64, true>& a, long long* b) { *b = a.to_int64(); }
    CUDA_CALLABLE_MEMBER inline void copy_bits(long long a, ac_int<64, true>* b) { *b = ac_int<64, true>(a); }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const long long a[2], long long(*b)[2]) {
      (*b)[0] = a[0];
      (*b)[1] = a[1];
    }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_int<128, true>& a, long long(*b)[2]) {
      (*b)[0] = a.to_int64();
      (*b)[1] = a.slc<64>(64).to_int64();
    }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const long long a[2], ac_int<128, true>* b) {
      *b = 0;
      b->set_slc(0, ac_int<64, true>(a[0]));
      b->set_slc(64, ac_int<64, true>(a[1]));
    }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const long long a[4], long long(*b)[4]) {
      (*b)[0] = a[0];
      (*b)[1] = a[1];
      (*b)[2] = a[2];
      (*b)[3] = a[3];
    }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_int<256, true>& a, long long(*b)[4]) {
      (*b)[0] = a.to_int64();
      (*b)[1] = a.slc<64>(64).to_int64();
      (*b)[2] = a.slc<64>(128).to_int64();
      (*b)[3] = a.slc<64>(192).to_int64();
    }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const long long a[4], ac_int<256, true>* b) {
      *b = 0;
      b->set_slc(0, ac_int<64, true>(a[0]));
      b->set_slc(64, ac_int<64, true>(a[1]));
    ...
    CUDA_CALLABLE_MEMBER inline void copy_bits(float f, int* x);
    CUDA_CALLABLE_MEMBER inline void copy_bits(double f, long long* x);
    CUDA_CALLABLE_MEMBER inline void copy_bits(int x, float* f);
    CUDA_CALLABLE_MEMBER inline void copy_bits(long long x, double* f);

    CUDA_CALLABLE_MEMBER inline void copy_bits(float f, ac_int<32, true>* x) {
      int x_i;
      copy_bits(f, &x_i);
      *x = x_i;
    }
    CUDA_CALLABLE_MEMBER inline void copy_bits(double f, ac_int<64, true>* x) {
      long long x_i;
      copy_bits(f, &x_i);
      *x = x_i;
    }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_int<32, true>& x, float* f) { copy_bits(x.to_int(), f); }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_int<64, true>& x, double* f) { copy_bits(x.to_int64(), f); }
  }
  ...
  public:
    ...
    CUDA_CALLABLE_MEMBER static ac_std_float nan() {
      ac_std_float r;
      r.d = 0;
      r.d.set_slc(mant_bits - 1, ac_int<e_width + 1, true>(-1));
      return r;
    }
    CUDA_CALLABLE_MEMBER static ac_std_float inf() {
      ac_std_float r;
      r.d = 0;
      r.d.set_slc(mant_bits, ac_int<e_width, true>(-1));
      return r;
    }
    CUDA_CALLABLE_MEMBER static ac_std_float denorm_min() {   // smallest positive non zero value (subnorm if supported)
      ac_std_float r;
      r.d = 1;
      return r;
    }
    CUDA_CALLABLE_MEMBER static ac_std_float min() {   // smallest NORMAL positive non zero value
      ac_std_float r;
      r.d = 0;
      r.d[width - 1 - e_width] = true;
      return r;
    }
    CUDA_CALLABLE_MEMBER static ac_std_float max() {   // largest pos finite value
      ac_std_float r;
      r.d = -1;
      r.d[width - 1] = false;
    ...
    CUDA_CALLABLE_MEMBER static ac_std_float epsilon() {
    ...
    CUDA_CALLABLE_MEMBER ac_std_float() {}
    CUDA_CALLABLE_MEMBER ac_std_float(const ac_std_float& f) : d(f.d) {}
    template<int WR, ac_q_mode QR>
    CUDA_CALLABLE_MEMBER ac_std_float<WR, E> convert() const {
    ...
    CUDA_CALLABLE_MEMBER ac_fixed<WFX, IFX, SFX, QFX, OFX> convert_to_ac_fixed(bool map_inf = false) const {
    ...
    CUDA_CALLABLE_MEMBER ac_int<WI, SI> convert_to_ac_int(bool map_inf = false) const {
      return convert_to_ac_fixed<WI, WI, SI, AC_TRN_ZERO, AC_WRAP>(map_inf).to_ac_int();
    }
    CUDA_CALLABLE_MEMBER int convert_to_int(bool map_inf = false) const {
      return convert_to_ac_int<32, true>(map_inf).to_int();
    }
    CUDA_CALLABLE_MEMBER long long convert_to_int64(bool map_inf = false) const {
      return convert_to_ac_int<64, true>(map_inf).to_int64();
    }

    template<int W2>
    CUDA_CALLABLE_MEMBER explicit ac_std_float(const ac_std_float<W2, E>& f) {
      *this = f.template convert<W, AC_RND_CONV>();
    }
    template<int WR, int ER, ac_q_mode QR>
    CUDA_CALLABLE_MEMBER ac_std_float<WR, ER> convert() const {
      ac_private::check_supported<QR>();
    ...
    CUDA_CALLABLE_MEMBER explicit ac_std_float(const ac_std_float<W2, E2>& f) {
      *this = f.template convert<W, E, AC_RND_CONV>();
    }
    template<ac_ieee_float_format Format>
    CUDA_CALLABLE_MEMBER explicit ac_std_float(const ac_ieee_float<Format>& f);

    CUDA_CALLABLE_MEMBER explicit ac_std_float(const ac::bfloat16& f);

    template<ac_q_mode Q>
    CUDA_CALLABLE_MEMBER explicit ac_std_float(const ac_float<mu_bits + 1, 2, E, Q>& f) {
    ...
    CUDA_CALLABLE_MEMBER void assign_from(const ac_fixed<WFX, IFX, SFX, QFX, OFX>& fx) {
    ...
    CUDA_CALLABLE_MEMBER void assign_from(const ac_int<WI, SI>& x) {
      this->template assign_from<Q>(ac_fixed<WI, WI, SI>(x));
    }
    template<int WFX, int IFX, bool SFX, ac_q_mode QFX, ac_o_mode OFX>
    CUDA_CALLABLE_MEMBER explicit ac_std_float(const ac_fixed<WFX, IFX, SFX, QFX, OFX>& fx) {
      assign_from<AC_RND_CONV>(fx);
    }
    template<int WI, bool SI>
    CUDA_CALLABLE_MEMBER explicit ac_std_float(const ac_int<WI, SI>& x) {
      assign_from<AC_RND_CONV>(x);
    }
    CUDA_CALLABLE_MEMBER explicit ac_std_float(float f) {
    ...
    CUDA_CALLABLE_MEMBER explicit ac_std_float(double f) {
      const int w_bits = sizeof(f) * 8;
    ...
    CUDA_CALLABLE_MEMBER explicit ac_std_float(int x) {
      *this = ac_std_float(ac_fixed<32, 32, true>(x));
    }
    CUDA_CALLABLE_MEMBER explicit ac_std_float(long long x) {
      *this = ac_std_float(ac_fixed<64, 64, true>(x));
    }
    CUDA_CALLABLE_MEMBER const ac_int<W, true>& data() const { return d; }
    CUDA_CALLABLE_MEMBER const ac_int<W, true>& data_ac_int() const { return d; }
    CUDA_CALLABLE_MEMBER void set_data(const ac_int<W, true>& data, bool assert_on_nan = false, bool assert_on_inf = false) {
      d = data;
      if (assert_on_nan)
    ...
    CUDA_CALLABLE_MEMBER int fpclassify() const {
    ...
    CUDA_CALLABLE_MEMBER bool isfinite() const {
      ac_int<E, true> e = d.template slc<E>(mant_bits);
      return e != -1;
    }
    CUDA_CALLABLE_MEMBER bool isnormal() const {
      ac_int<E, true> e = d.template slc<E>(mant_bits);
      return (e || !(ac_int<mant_bits, false>)d) && e != -1;
    }
    CUDA_CALLABLE_MEMBER bool isnan() const {
      if (isfinite())
        return false;
      ac_int<mant_bits, false> m = d;
      return !!m;
    }
    CUDA_CALLABLE_MEMBER bool isinf() const {
      if (isfinite())
        return false;
      ac_int<mant_bits, false> m = d;
      return !m;
    }
    CUDA_CALLABLE_MEMBER const ac_float<mant_bits + 2, 2, E, AC_RND_CONV> to_ac_float() const {
      ac_int<E, true> e = d.template slc<E>(mant_bits);
      bool normal = !!e;
      bool sign = d[W - 1];
      bool inf = e == -1;
    ...
    template<ac_ieee_float_format Format>
    CUDA_CALLABLE_MEMBER ac_ieee_float<Format> to_ac_ieee_float() const;
    CUDA_CALLABLE_MEMBER float to_float() const {
      ac_std_float<32, 8> t(*this);
      float f;
      ac::copy_bits(t.d, &f);
      return f;
    }
    CUDA_CALLABLE_MEMBER double to_double() const {
  ...
  public:
    CUDA_CALLABLE_MEMBER static ac_std_float zero() {
      ac_std_float r;
      r.d = 0;
      return r;
    }
    CUDA_CALLABLE_MEMBER static ac_std_float one() {
      ac_std_float r;
      r.d = 0;
    ...
    CUDA_CALLABLE_MEMBER ac_std_float add_generic(const ac_std_float& op2) const {
      ac_private::check_supported<QR>();
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float add(const ac_std_float& op2) const {
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float sub(const ac_std_float& op2) const {
      return add<QR, No_SubNormals>(-op2);
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float mult_generic(const ac_std_float& op2) const {
      ac_private::check_supported<QR>();
      e_t op1_e, op2_e;
      bool op1_normal, op1_sign, op1_zero, op2_normal, op2_sign, op2_zero;
      bool op1_inf, op1_nan, op2_inf, op2_nan;
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float mult(const ac_std_float& op2) const {
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float div_generic(const ac_std_float& op2) const {
      ac_private::check_supported<QR>();
      e_t op1_e, op2_e;
      bool op1_normal, op1_sign, op1_zero, op2_normal, op2_sign, op2_zero;
      bool op1_inf, op1_nan, op2_inf, op2_nan;
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float div(const ac_std_float& op2) const {
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float fma_generic(const ac_std_float& op2, const ac_std_float& op3) const {
      ac_private::check_supported<QR>();
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float fma(const ac_std_float& op2, const ac_std_float& op3) const {
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float sqrt_generic() const {
      ac_private::check_supported<QR>();
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_std_float sqrt() const {
    ...
    CUDA_CALLABLE_MEMBER ac_std_float operator +(const ac_std_float& op2) const {
    ...
    CUDA_CALLABLE_MEMBER ac_std_float& operator +=(const ac_std_float& op2) {
      *this = operator +(op2);
      return *this;
    }
    CUDA_CALLABLE_MEMBER ac_std_float& operator -=(const ac_std_float& op2) {
    ...
    CUDA_CALLABLE_MEMBER bool operator ==(const ac_std_float& op2) const {
      return ((d == op2.d) && !isnan()) || (operator !() && op2.operator !());
    }
    CUDA_CALLABLE_MEMBER bool operator !=(const ac_std_float& op2) const {
      return !operator ==(op2);
    }
    CUDA_CALLABLE_MEMBER bool magnitude_lt(const ac_std_float& op2) const {
      return ac_int<W - 1, false>(d) < ac_int<W - 1, false>(op2.d);
    }
    CUDA_CALLABLE_MEMBER bool neg() const { return d[W - 1]; }
    CUDA_CALLABLE_MEMBER bool operator <(const ac_std_float& op2) const {
      return
    ...
    CUDA_CALLABLE_MEMBER bool operator !() const { return !ac_int<W - 1, false>(d); }
    CUDA_CALLABLE_MEMBER ac_std_float operator -() const {
      ac_std_float r(*this);
      r.d[W - 1] = !d[W - 1];
      return r;
    }
    ...
    CUDA_CALLABLE_MEMBER ac_std_float abs() const {
      ac_std_float r(*this);
      r.d[W - 1] = false;
      return r;
    }
    CUDA_CALLABLE_MEMBER ac_std_float copysign(const ac_std_float& op2) const {
      ac_std_float r(*this);
      r.d[W - 1] = op2.d[W - 1];
      return r;
    }
    CUDA_CALLABLE_MEMBER bool signbit() const {
      return d[W - 1];
    }
    CUDA_CALLABLE_MEMBER void set_signbit(bool s) {
      d[W - 1] = s;
    }
    CUDA_CALLABLE_MEMBER ac_std_float ceil() const {
    ...
    CUDA_CALLABLE_MEMBER ac_std_float floor() const {
      ac_int<E, false> e = d.template slc<E>(mant_bits);
      bool sign = d[W - 1];
      if (!d.template slc<W - 1>(0))
        return *this;
    ...
    CUDA_CALLABLE_MEMBER ac_std_float trunc() const {
      ac_int<E, false> e = d.template slc<E>(mant_bits);
      if (e < exp_bias) {
        return zero();
      }
    ...
    CUDA_CALLABLE_MEMBER ac_std_float round() const {
      ac_int<E, false> e = d.template slc<E>(mant_bits);
      if (e < exp_bias - 1) {
        return zero();
      }
  ...
  namespace ac {
    ...
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_std_float<32, 8>& x, float* f) {
      copy_bits(x.data().to_int(), f);
    }
    CUDA_CALLABLE_MEMBER inline void copy_bits(const ac_std_float<64, 11>& x, double* f) {
  ...
  public:
    ...
    typedef ac_float<width - e_width + 1, 2, e_width, AC_RND_CONV> ac_float_t;
    data_t d;
    CUDA_CALLABLE_MEMBER ac_ieee_float_base() {}
    CUDA_CALLABLE_MEMBER ac_ieee_float_base(const ac_ieee_float_base& f) {
      ac::copy_bits(f.d, &d);
    }
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float_base(const helper_t& op) {
      ac::copy_bits(op.data(), &d);
    }
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float_base(double f);
  protected:
    CUDA_CALLABLE_MEMBER helper_t to_helper_t() const {
  ...
  public:
    CUDA_CALLABLE_MEMBER void set_data(const data_t& op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER void set_data(const ac_int<width, true>& op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER const data_t& data() const { return d; }
    CUDA_CALLABLE_MEMBER ac_int<width, true> data_ac_int() const {
      ac_int<width, true> x;
      ac::copy_bits(d, &x);
      return x;
    }
    CUDA_CALLABLE_MEMBER bool signbit() const { return d[lls - 1] < 0; }
    CUDA_CALLABLE_MEMBER void set_signbit(bool s) {
  ...
  public:
...
#if __cplusplus > 199711L
    CUDA_CALLABLE_MEMBER explicit operator float() const { return to_float(); }
#endif
    CUDA_CALLABLE_MEMBER void set_data(short op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER void set_data(const ac_int<width, true>& op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER const data_t& data() const { return d; }
    CUDA_CALLABLE_MEMBER ac_int<width, true> data_ac_int() const {
      ac_int<width, true> x;
    ...
    CUDA_CALLABLE_MEMBER bool signbit() const { return d < 0; }
    CUDA_CALLABLE_MEMBER void set_signbit(bool s) {
  ...
  struct float_helper {
    float d;
    CUDA_CALLABLE_MEMBER float_helper() {}
    CUDA_CALLABLE_MEMBER float_helper(float f) { d = f; }
    CUDA_CALLABLE_MEMBER float_helper(const float_helper& f) { d = f.d; }
    CUDA_CALLABLE_MEMBER float_helper(const float_helper& f, bool no_subnormals) {
      d = no_subnormals && f.fpclassify() == FP_SUBNORMAL ? std::signbit(f.d) ? -0.0 : 0.0 : f.d;
    }
    CUDA_CALLABLE_MEMBER float_helper(const ac_std_float<32, 8>& f) { set_data(f.data().to_int()); }
    template<ac_q_mode Q>
    CUDA_CALLABLE_MEMBER float_helper(const ac_float<25, 2, 8, Q>& f) : d(f.to_float()) {}
    CUDA_CALLABLE_MEMBER const float& data() const { return d; }
    CUDA_CALLABLE_MEMBER void set_data(int data) { ac::copy_bits(data, &d); }
    CUDA_CALLABLE_MEMBER void set_data(float data) { d = data; }
    CUDA_CALLABLE_MEMBER operator float() const { return d; }
    CUDA_CALLABLE_MEMBER float to_float() const { return d; }
    CUDA_CALLABLE_MEMBER int fpclassify() const
    {
#ifndef __CUDA_ARCH__
      return std::fpclassify(d);
#else
      // TBD: Implement fpclassify for CUDA
      return 0;
#endif
    }
    CUDA_CALLABLE_MEMBER bool isfinite() const
...
#else
      // TBD: Implement isfinite for CUDA
      return true;
#endif
    }
    CUDA_CALLABLE_MEMBER bool isnormal() const
...
#else
      // TBD: Implement isnormal for CUDA
      return true;
#endif
    }
    CUDA_CALLABLE_MEMBER bool isinf() const
    ...
    CUDA_CALLABLE_MEMBER bool isnan() const
    {
      ...
      return std::isnan(d);
#else
      // TBD: Implement isnan for CUDA
      return false;
#endif
    }
    CUDA_CALLABLE_MEMBER static float nan() { return ac_std_float<32, 8>::nan().to_float(); }
    CUDA_CALLABLE_MEMBER static float inf() { return ac_std_float<32, 8>::inf().to_float(); }
    CUDA_CALLABLE_MEMBER static float denorm_min() { return ac_std_float<32, 8>::denorm_min().to_float(); }
    CUDA_CALLABLE_MEMBER static float min() { return ac_std_float<32, 8>::min().to_float(); }
    CUDA_CALLABLE_MEMBER static float max() { return ac_std_float<32, 8>::max().to_float(); }
    CUDA_CALLABLE_MEMBER static float epsilon() { return ac_std_float<32, 8>::epsilon().to_float(); }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER float_helper add(const float_helper& op2) const {
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER float_helper sub(const float_helper& op2) const {
      ac_private::check_supported2<QR>();
      return float_helper(float_helper(*this, No_SubNormals) - float_helper(op2, No_SubNormals), No_SubNormals);
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER float_helper mult(const float_helper& op2) const {
      ac_private::check_supported2<QR>();
      return float_helper(float_helper(*this, No_SubNormals) * float_helper(op2, No_SubNormals), No_SubNormals);
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER float_helper div(const float_helper& op2) const {
      ac_private::check_supported2<QR>();
      return float_helper(float_helper(*this, No_SubNormals) / float_helper(op2, No_SubNormals), No_SubNormals);
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER float_helper fma(const float_helper& op2, const float_helper& op3) const {
      ac_private::check_supported2<QR>();
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER float_helper sqrt() const {
      ac_private::check_supported2<QR>();
      return float_helper(::sqrtf(float_helper(*this, No_SubNormals)), No_SubNormals);
    }
    CUDA_CALLABLE_MEMBER float_helper ceil() const { return float_helper(std::ceil(d)); }
    CUDA_CALLABLE_MEMBER float_helper floor() const { return float_helper(std::floor(d)); }
    CUDA_CALLABLE_MEMBER float_helper trunc() const { return float_helper(::truncf(d)); }
    CUDA_CALLABLE_MEMBER float_helper round() const { return float_helper(::roundf(d)); }
    CUDA_CALLABLE_MEMBER bool operator !() const { return !d; }
  };
  ...
  public:
    ...
    data_t d;
    CUDA_CALLABLE_MEMBER ac_ieee_float_base() {}
    CUDA_CALLABLE_MEMBER ac_ieee_float_base(const ac_ieee_float_base& f) : d(f.d) {}
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float_base(const helper_t& op) : d(op.data()) {}
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float_base(float f) { ac::copy_bits(f, &d); }
  protected:
    CUDA_CALLABLE_MEMBER helper_t to_helper_t() const {
      helper_t x;
      x.set_data(d);
  ...
  public:
#if __cplusplus > 199711L
    CUDA_CALLABLE_MEMBER explicit operator float() const {
      float f;
      ac::copy_bits(d, &f);
      return f;
    }
    ...
    CUDA_CALLABLE_MEMBER void set_data(int op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER void set_data(float op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER void set_data(const ac_int<width, true>& op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER const data_t& data() const { return d; }
    CUDA_CALLABLE_MEMBER ac_int<width, true> data_ac_int() const {
      ac_int<width, true> x;
  ...
  struct double_helper {
    double d;
    CUDA_CALLABLE_MEMBER double_helper() {}
    CUDA_CALLABLE_MEMBER double_helper(double f) { d = f; }
    CUDA_CALLABLE_MEMBER double_helper(const float_helper& f) { d = f.d; }
    CUDA_CALLABLE_MEMBER double_helper(const double_helper& f, bool no_subnormals) {
      d = no_subnormals && f.fpclassify() == FP_SUBNORMAL ? std::signbit(f.d) ? -0.0 : 0.0 : f.d;
    }
    CUDA_CALLABLE_MEMBER double_helper(const ac_std_float<64, 11>& f) { set_data(f.data().to_int64()); }
    template<ac_q_mode Q>
    CUDA_CALLABLE_MEMBER double_helper(const ac_float<54, 2, 11, Q>& f) : d(f.to_double()) {}
    CUDA_CALLABLE_MEMBER const double& data() const { return d; }
    CUDA_CALLABLE_MEMBER void set_data(long long data) {
      ac::copy_bits(data, &d);
    }
    CUDA_CALLABLE_MEMBER void set_data(double data) { d = data; }
    CUDA_CALLABLE_MEMBER operator double() const { return d; }
    CUDA_CALLABLE_MEMBER double to_double() const { return d; }
    CUDA_CALLABLE_MEMBER int fpclassify() const
    {
#ifndef __CUDA_ARCH__
      return std::fpclassify(d);
    ...
    CUDA_CALLABLE_MEMBER static double nan() { return ac_std_float<64, 11>::nan().to_double(); }
    CUDA_CALLABLE_MEMBER static double inf() { return ac_std_float<64, 11>::inf().to_double(); }
    CUDA_CALLABLE_MEMBER static double denorm_min() { return ac_std_float<64, 11>::denorm_min().to_double(); }
    CUDA_CALLABLE_MEMBER static double min() { return ac_std_float<64, 11>::min().to_double(); }
    CUDA_CALLABLE_MEMBER static double max() { return ac_std_float<64, 11>::max().to_double(); }
    CUDA_CALLABLE_MEMBER static double epsilon() { return ac_std_float<64, 11>::epsilon().to_double(); }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER double_helper add(const double_helper& op2) const {
      ac_private::check_supported2<QR>();
      return double_helper(double_helper(*this, No_SubNormals) + double_helper(op2, No_SubNormals), No_SubNormals);
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER double_helper sub(const double_helper& op2) const {
      ac_private::check_supported2<QR>();
      return double_helper(double_helper(*this, No_SubNormals) - double_helper(op2, No_SubNormals), No_SubNormals);
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER double_helper mult(const double_helper& op2) const {
      ac_private::check_supported2<QR>();
      return double_helper(double_helper(*this, No_SubNormals) * double_helper(op2, No_SubNormals), No_SubNormals);
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER double_helper div(const double_helper& op2) const {
      ac_private::check_supported2<QR>();
      return double_helper(double_helper(*this, No_SubNormals) / double_helper(op2, No_SubNormals), No_SubNormals);
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER double_helper fma(const double_helper& op2, const double_helper& op3) const {
      ac_private::check_supported2<QR>();
    ...
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER double_helper sqrt() const {
      ac_private::check_supported2<QR>();
      return double_helper(::sqrt((double)double_helper(*this, No_SubNormals)), No_SubNormals);
    }
    CUDA_CALLABLE_MEMBER double_helper ceil() const { return double_helper(std::ceil(d)); }
    CUDA_CALLABLE_MEMBER double_helper floor() const { return double_helper(std::floor(d)); }
    CUDA_CALLABLE_MEMBER double_helper trunc() const { return double_helper(::trunc(d)); }
    CUDA_CALLABLE_MEMBER double_helper round() const { return double_helper(::round(d)); }
    CUDA_CALLABLE_MEMBER bool operator !() const { return !d; }
  };
  ...
  public:
    ...
    CUDA_CALLABLE_MEMBER ac_ieee_float_base(const ac_ieee_float_base& f) : d(f.d) {}
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float_base(const helper_t& op) : d(op.data()) {}
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float_base(double f) { ac::copy_bits(f, &d); }
  protected:
    CUDA_CALLABLE_MEMBER helper_t to_helper_t() const {
      helper_t x;
      x.set_data(d);
  ...
  public:
#if __cplusplus > 199711L
    CUDA_CALLABLE_MEMBER explicit operator double() const {
      double f;
      ac::copy_bits(d, &f);
      return f;
    }
    ...
    CUDA_CALLABLE_MEMBER void set_data(long long op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER void set_data(double op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER void set_data(const ac_int<width, true>& op) { ac::copy_bits(op, &d); }
    CUDA_CALLABLE_MEMBER const data_t& data() const { return d; }
    CUDA_CALLABLE_MEMBER ac_int<width, true> data_ac_int() const {
      ac_int<width, true> x;
  ...
  public:
    ...
    typedef ac_std_float<width, e_width> ac_std_float_t;
  public:
    CUDA_CALLABLE_MEMBER static ac_ieee_float nan() { return ac_ieee_float(helper_t::nan()); }
    CUDA_CALLABLE_MEMBER static ac_ieee_float inf() { return ac_ieee_float(helper_t::inf()); }
    CUDA_CALLABLE_MEMBER static ac_ieee_float denorm_min() { return ac_ieee_float(helper_t::denorm_min()); }
    CUDA_CALLABLE_MEMBER static ac_ieee_float min() { return ac_ieee_float(helper_t::min()); }
    CUDA_CALLABLE_MEMBER static ac_ieee_float max() { return ac_ieee_float(helper_t::max()); }
    CUDA_CALLABLE_MEMBER static ac_ieee_float epsilon() { return ac_ieee_float(helper_t::epsilon()); }
    CUDA_CALLABLE_MEMBER static ac_ieee_float zero() { return ac_ieee_float(ac_std_float_t::zero()); }
    CUDA_CALLABLE_MEMBER static ac_ieee_float one() { return ac_ieee_float(ac_std_float_t::one()); }
    CUDA_CALLABLE_MEMBER ac_ieee_float() {}
  private:
    CUDA_CALLABLE_MEMBER ac_ieee_float(const Base& f) : Base(f) {}
  public:
    CUDA_CALLABLE_MEMBER ac_ieee_float(const ac_std_float<width, e_width>& f) : Base(f) {}
    CUDA_CALLABLE_MEMBER ac_ieee_float(const ac_ieee_float& f) : Base(f) {}
    template<ac_ieee_float_format Format2>
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(const ac_ieee_float<Format2>& f) : Base(ac_std_float_t(f.to_ac_std_float())) {}
    template<int W, int E>
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(const ac_std_float<W, E>& f) : Base(ac_std_float_t(f)) {}
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(const ac::bfloat16& f);
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(const ac_float_t& f) : Base(ac_std_float_t(f)) {}
    template<int WFX, int IFX, bool SFX, ac_q_mode QFX, ac_o_mode OFX>
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(const ac_fixed<WFX, IFX, SFX, QFX, OFX>& fx) : Base(ac_std_float_t(fx)) {}
    template<int WI, bool SI>
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(const ac_int<WI, SI>& x) : Base(ac_std_float_t(x)) {}
    template<ac_q_mode Q>
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(const ac_float<width - e_width + 1, 2, e_width, Q>& f) : Base(ac_std_float_t(f)) {}
    template<ac_ieee_float_format Format2>
    CUDA_CALLABLE_MEMBER ac_ieee_float<Format2> to_ac_ieee_float() const { return ac_ieee_float<Format2>(*this); }
    CUDA_CALLABLE_MEMBER const ac_float_t to_ac_float() const {
      return to_ac_std_float().to_ac_float();
    }
    CUDA_CALLABLE_MEMBER const ac_std_float<width, e_width> to_ac_std_float() const {
    ...
    CUDA_CALLABLE_MEMBER void set_data(const data_t& data) {
      Base::set_data(data);
    }
    CUDA_CALLABLE_MEMBER const ac_int<width, true> data_ac_int() const { return Base::data_ac_int(); }
    CUDA_CALLABLE_MEMBER const data_t& data() const { return Base::d; }
    template<typename T>
    CUDA_CALLABLE_MEMBER ac_ieee_float(const T& f, typename ac_private::template ac_ieee_float_constructor<Format, T>::type d = 0) : Base(ac_std_float_t(f)) {}
    template<typename T>
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(const T& f, typename ac_private::template ac_ieee_float_constructor<Format, T>::type_explicit d = 0) : Base(ac_std_float_t(f)) {}
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(int x) {
      *this = ac_ieee_float(ac_fixed<32, 32, true>(x));
    }
    CUDA_CALLABLE_MEMBER explicit ac_ieee_float(long long x) {
    ...
    CUDA_CALLABLE_MEMBER int fpclassify() const { return Base::to_helper_t().fpclassify(); }
    CUDA_CALLABLE_MEMBER bool isfinite() const { return Base::to_helper_t().isfinite(); }
    CUDA_CALLABLE_MEMBER bool isnormal() const { return Base::to_helper_t().isnormal(); }
    CUDA_CALLABLE_MEMBER bool isinf() const { return Base::to_helper_t().isinf(); }
    CUDA_CALLABLE_MEMBER bool isnan() const { return Base::to_helper_t().isnan(); }

    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_ieee_float add(const ac_ieee_float& op2) const {
      return ac_ieee_float(Base(Base::to_helper_t().template add<QR, No_SubNormals>(op2.Base::to_helper_t())));
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_ieee_float sub(const ac_ieee_float& op2) const {
      return ac_ieee_float(Base(Base::to_helper_t().template sub<QR, No_SubNormals>(op2.Base::to_helper_t())));
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_ieee_float mult(const ac_ieee_float& op2) const {
      return ac_ieee_float(Base(Base::to_helper_t().template mult<QR, No_SubNormals>(op2.Base::to_helper_t())));
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_ieee_float div(const ac_ieee_float& op2) const {
      return ac_ieee_float(Base(Base::to_helper_t().template div<QR, No_SubNormals>(op2.Base::to_helper_t())));
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_ieee_float fma(const ac_ieee_float& op2, const ac_ieee_float& op3) const {
      return ac_ieee_float(Base(Base::to_helper_t().template fma<QR, No_SubNormals>(op2.Base::to_helper_t(), op3.Base::to_helper_t())));
    }
    template<ac_q_mode QR, bool No_SubNormals>
    CUDA_CALLABLE_MEMBER ac_ieee_float sqrt() const {
      return ac_ieee_float(Base(Base::to_helper_t().template sqrt<QR, No_SubNormals>()));
    }

    CUDA_CALLABLE_MEMBER ac_ieee_float operator +(const ac_ieee_float& op2) const {
    ...
    CUDA_CALLABLE_MEMBER ac_ieee_float& operator +=(const ac_ieee_float& op2) {
    ...
    CUDA_CALLABLE_MEMBER bool operator ==(const ac_ieee_float& op2) const {
    ...
    CUDA_CALLABLE_MEMBER bool operator !() const { return !Base::to_helper_t(); }
    CUDA_CALLABLE_MEMBER ac_ieee_float operator -() const {
    ...
    CUDA_CALLABLE_MEMBER ac_ieee_float abs() const {
      ac_ieee_float r(*this);
      r.set_signbit(false);
      return r;
    }
    CUDA_CALLABLE_MEMBER ac_ieee_float copysign(const ac_ieee_float& op2) const {
      ac_ieee_float r(*this);
      r.set_signbit(op2.signbit());
      return r;
    }
    CUDA_CALLABLE_MEMBER bool signbit() const { return Base::signbit(); }
    CUDA_CALLABLE_MEMBER ac_ieee_float add(const ac_ieee_float& op1, const ac_ieee_float& op2) {
      return *this = op1 + op2;
    }
    CUDA_CALLABLE_MEMBER ac_ieee_float ceil() const {
      return ac_ieee_float(Base(Base::to_helper_t().ceil()));
    }
    CUDA_CALLABLE_MEMBER ac_ieee_float floor() const {
      return ac_ieee_float(Base(Base::to_helper_t().floor()));
    }
    CUDA_CALLABLE_MEMBER ac_ieee_float trunc() const {
      return ac_ieee_float(Base(Base::to_helper_t().trunc()));
    }
    CUDA_CALLABLE_MEMBER ac_ieee_float round() const {
      return ac_ieee_float(Base(Base::to_helper_t().round()));
    }
    CUDA_CALLABLE_MEMBER ac_ieee_float sub(const ac_ieee_float& op1, const ac_ieee_float& op2) {
      return *this = op1 - op2;
    }
    CUDA_CALLABLE_MEMBER ac_ieee_float mult(const ac_ieee_float& op1, const ac_ieee_float& op2) {
      return *this = op1 * op2;
    }
    CUDA_CALLABLE_MEMBER ac_ieee_float div(const ac_ieee_float& op1, const ac_ieee_float& op2) {
      return *this = op1 / op2;
    }
  };
  ...
  namespace ac {
    ...
    public:
      ...
      static const int e_width = 8;
      static const int exp_bias = (1 << (e_width - 1)) - 1;
      CUDA_CALLABLE_MEMBER static bfloat16 nan() { return bfloat16(helper_t::nan()); }
      CUDA_CALLABLE_MEMBER static bfloat16 inf() { return bfloat16(helper_t::inf()); }
      CUDA_CALLABLE_MEMBER static bfloat16 denorm_min() { return bfloat16(helper_t::denorm_min()); }
      CUDA_CALLABLE_MEMBER static bfloat16 min() { return bfloat16(helper_t::min()); }
      CUDA_CALLABLE_MEMBER static bfloat16 max() { return bfloat16(helper_t::max()); }
      CUDA_CALLABLE_MEMBER static bfloat16 epsilon() { return bfloat16(helper_t::epsilon()); }
      CUDA_CALLABLE_MEMBER static bfloat16 zero() { return bfloat16(ac_std_float_t::zero()); }
      CUDA_CALLABLE_MEMBER static bfloat16 one() { return bfloat16(ac_std_float_t::one()); }
      typedef ac_std_float<width, e_width> helper_t;
      typedef short data_t;
      typedef ac_float<width - e_width + 1, 2, e_width, AC_RND_CONV> ac_float_t;
      typedef ac_std_float<width, e_width> ac_std_float_t;
      data_t d;
      CUDA_CALLABLE_MEMBER bfloat16() {}
      CUDA_CALLABLE_MEMBER bfloat16(const bfloat16& f) : d(f.d) {}
      CUDA_CALLABLE_MEMBER bfloat16(const ac_std_float_t& op) : d(op.data()) {}
      CUDA_CALLABLE_MEMBER bfloat16(float f) { int x; ac::copy_bits(f, &x); d = (short)(x >> 16); }
      template<int W2>
      CUDA_CALLABLE_MEMBER explicit bfloat16(const ac_std_float<W2, e_width>& f) {
        *this = f.template convert<width, AC_TRN_ZERO>();
      }
      template<int W2, int E2>
      CUDA_CALLABLE_MEMBER explicit bfloat16(const ac_std_float<W2, E2>& f) {
        *this = f.template convert<width, e_width, AC_TRN_ZERO>();
      }
      template<ac_ieee_float_format Format>
      CUDA_CALLABLE_MEMBER explicit bfloat16(const ac_ieee_float<Format>& f) {
        *this = f.to_ac_std_float().template convert<width, e_width, AC_TRN_ZERO>();
      }
      template<int WFX, int IFX, bool SFX, ac_q_mode QFX, ac_o_mode OFX>
      CUDA_CALLABLE_MEMBER explicit bfloat16(const ac_fixed<WFX, IFX, SFX, QFX, OFX>& fx) {
        ac_std_float_t x;
        x.assign_from<AC_TRN_ZERO>(fx);
        *this = x;
      }
      template<int WI, bool SI>
      CUDA_CALLABLE_MEMBER explicit bfloat16(const ac_int<WI, SI>& xi) {
        ac_std_float_t x;
        x.assign_from<AC_TRN_ZERO>(xi);
        *this = x;
      }
    private:
      CUDA_CALLABLE_MEMBER const helper_t to_helper_t() const {
        helper_t x;
        x.set_data(d);
        return x;
      }
    public:
      CUDA_CALLABLE_MEMBER const ac_std_float_t to_ac_std_float() const {
        ac_std_float_t x;
        x.set_data(d);
        return x;
      }
      template<ac_ieee_float_format Format>
      CUDA_CALLABLE_MEMBER ac_ieee_float<Format> to_ac_ieee_float() const { return ac_ieee_float<Format>(*this); }
      CUDA_CALLABLE_MEMBER const ac_float_t to_ac_float() const {
      ...
      CUDA_CALLABLE_MEMBER int fpclassify() const { return to_helper_t().fpclassify(); }
      CUDA_CALLABLE_MEMBER bool isfinite() const { return to_helper_t().isfinite(); }
      CUDA_CALLABLE_MEMBER bool isnormal() const { return to_helper_t().isnormal(); }
      CUDA_CALLABLE_MEMBER bool isinf() const { return to_helper_t().isinf(); }
      CUDA_CALLABLE_MEMBER bool isnan() const { return to_helper_t().isnan(); }
      CUDA_CALLABLE_MEMBER void set_data(short op) { ac::copy_bits(op, &d); }
      CUDA_CALLABLE_MEMBER void set_data(const ac_int<width, true>& op) { ac::copy_bits(op, &d); }
      CUDA_CALLABLE_MEMBER const data_t& data() const { return d; }
      CUDA_CALLABLE_MEMBER ac_int<16, true> data_ac_int() const { return ac_int<16, true>(d); }
    ...
    //  explicit bfloat16(const T& val) { *this = bfloat16(static_cast<float>(val)); }
      CUDA_CALLABLE_MEMBER explicit bfloat16(unsigned short val) {
        ac_std_float_t t;
        t.assign_from<AC_TRN_ZERO>(ac_int<16, false>(val));
        *this = t;
      }
      CUDA_CALLABLE_MEMBER explicit bfloat16(int val) {
        ac_std_float_t t;
        t.assign_from<AC_TRN_ZERO>(ac_int<32, true>(val));
        *this = t;
      }
      CUDA_CALLABLE_MEMBER explicit bfloat16(unsigned int val) {
        ac_std_float_t t;
      ...
      CUDA_CALLABLE_MEMBER explicit bfloat16(long long val) {
        ac_std_float_t t;
        t.assign_from<AC_TRN_ZERO>(ac_int<64, false>(val));
        *this = t;
      }
      CUDA_CALLABLE_MEMBER explicit bfloat16(double val) { *this = bfloat16(ac_ieee_float<binary64>(val)); }

      template<ac_q_mode QR, bool No_SubNormals>
      CUDA_CALLABLE_MEMBER bfloat16 add(const bfloat16& op2) const {
        return bfloat16(to_helper_t().add<QR, No_SubNormals>(op2.to_helper_t()));
      }
      template<ac_q_mode QR, bool No_SubNormals>
      CUDA_CALLABLE_MEMBER bfloat16 sub(const bfloat16& op2) const {
        return bfloat16(to_helper_t().sub<QR, No_SubNormals>(op2.to_helper_t()));
      }
      template<ac_q_mode QR, bool No_SubNormals>
      CUDA_CALLABLE_MEMBER bfloat16 mult(const bfloat16& op2) const {
        return bfloat16(to_helper_t().mult<QR, No_SubNormals>(op2.to_helper_t()));
      }
      template<ac_q_mode QR, bool No_SubNormals>
      CUDA_CALLABLE_MEMBER bfloat16 div(const bfloat16& op2) const {
        return bfloat16(to_helper_t().div<QR, No_SubNormals>(op2.to_helper_t()));
      }
      template<ac_q_mode QR, bool No_SubNormals>
      CUDA_CALLABLE_MEMBER bfloat16 fma(const bfloat16& op2, const bfloat16& op3) const {
        return bfloat16(to_helper_t().fma<QR, No_SubNormals>(op2.to_helper_t(), op3.to_helper_t()));
      }
      template<ac_q_mode QR, bool No_SubNormals>
      CUDA_CALLABLE_MEMBER bfloat16 sqrt() const {
        return bfloat16(to_helper_t().sqrt<QR, No_SubNormals>());
      }

      CUDA_CALLABLE_MEMBER bfloat16 operator +(const bfloat16& op2) const {
      ...
      CUDA_CALLABLE_MEMBER bfloat16& operator +=(const bfloat16& op2) {
        return *this = operator +(op2);
      }
      CUDA_CALLABLE_MEMBER bfloat16& operator -=(const bfloat16& op2) {
        return *this = operator -(op2);
      ...
      CUDA_CALLABLE_MEMBER bool operator ==(const bfloat16& op2) const {
      ...
      CUDA_CALLABLE_MEMBER bool operator !() const { return !(d & 0x7fff); }
      CUDA_CALLABLE_MEMBER bfloat16 operator -() const {
        bfloat16 r(*this);
        r.set_signbit(!this->signbit());
        return r;
      }
      ...
      CUDA_CALLABLE_MEMBER bfloat16 abs() const {
        bfloat16 r(*this);
        r.set_signbit(false);
        return r;
      }
      CUDA_CALLABLE_MEMBER bfloat16 copysign(const bfloat16& op2) const {
        bfloat16 r(*this);
        r.set_signbit(op2.signbit());
        return r;
      }
      ...
      CUDA_CALLABLE_MEMBER bfloat16 ceil() const { return to_helper_t().ceil(); }
      CUDA_CALLABLE_MEMBER bfloat16 floor() const { return to_helper_t().floor(); }
      CUDA_CALLABLE_MEMBER bfloat16 trunc() const { return to_helper_t().trunc(); }
      CUDA_CALLABLE_MEMBER bfloat16 round() const { return to_helper_t().round(); }
    };
  ...
  template<int W, int E>
  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline ac_std_float<W, E>::ac_std_float(const ac_ieee_float<Format>& f) {
    *this = ac_std_float(f.to_ac_std_float());
  }

  template<int W, int E>
  CUDA_CALLABLE_MEMBER inline ac_std_float<W, E>::ac_std_float(const ac::bfloat16& f) {
    *this = ac_std_float(f.to_ac_std_float());
  }

  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline ac_ieee_float<Format>::ac_ieee_float(const ac::bfloat16& f) {
...
namespace std {
...
#endif
  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline ac_ieee_float<Format> abs(const ac_ieee_float<Format>& x) { return x.abs(); }
  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline ac_ieee_float<Format> fabs(const ac_ieee_float<Format>& x) { return x.abs(); }

  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline ac_ieee_float<Format> copysign(const ac_ieee_float<Format>& x, const ac_ieee_float<Format>& y) { return x.copysign(y); }

  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline int fpclassify(const ac_ieee_float<Format>& x) { return x.fpclassify(); }
  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline bool isfinite(const ac_ieee_float<Format>& x) { return x.isfinite(); }
  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline bool isnormal(const ac_ieee_float<Format>& x) { return x.isnormal(); }
  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline bool isinf(const ac_ieee_float<Format>& x) { return x.isinf(); }
  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline bool isnan(const ac_ieee_float<Format>& x) { return x.isnan(); }
  ...
  template<ac_ieee_float_format Format>
  CUDA_CALLABLE_MEMBER inline bool signbit(const ac_ieee_float<Format>& x) { return x.signbit(); }

  // Global functions for bfloat16
  CUDA_CALLABLE_MEMBER inline bool signbit(const ac::bfloat16& x) { return x.signbit(); }

  CUDA_CALLABLE_MEMBER inline int fpclassify(const ac::bfloat16& x) { return x.fpclassify(); }
  CUDA_CALLABLE_MEMBER inline bool isfinite(const ac::bfloat16& x) { return x.isfinite(); }
  CUDA_CALLABLE_MEMBER inline bool isnormal(const ac::bfloat16& x) { return x.isnormal(); }
  CUDA_CALLABLE_MEMBER inline bool isinf(const ac::bfloat16& x) { return x.isinf(); }
  CUDA_CALLABLE_MEMBER inline bool isnan(const ac::bfloat16& x) { return x.isnan(); }
}
