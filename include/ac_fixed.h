...
namespace __AC_NAMESPACE {
  ...
  namespace ac {
    ...
    class basic_num_ovf_base {
      bool d_enable;
    public:
      CUDA_CALLABLE_MEMBER basic_num_ovf_base() : d_enable(true) {}
      CUDA_CALLABLE_MEMBER void enable_ovf(bool a) { d_enable = a; }
      CUDA_CALLABLE_MEMBER bool is_enabled() const { return d_enable; }
      template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
      CUDA_CALLABLE_MEMBER void update(bool overflow, bool neg, const basic_num_ovf_base<W2, I2, S2, Q2, O2>& op2) {
      ...
      CUDA_CALLABLE_MEMBER void update(bool overflow, bool neg, double op2) {
...
#pragma builtin
    ...
    CUDA_CALLABLE_MEMBER inline Base& base() { return *this; }
    CUDA_CALLABLE_MEMBER inline const Base& base() const { return *this; }

    CUDA_CALLABLE_MEMBER inline void overflow_adjust(bool overflow, bool neg) {
      if (O == AC_WRAP) {
        bit_adjust();
        return;
      }
    ...
    CUDA_CALLABLE_MEMBER inline bool quantization_adjust(bool qb, bool r, bool s) {
      if (Q == AC_TRN)
        return false;
      if (Q == AC_RND_ZERO)
        qb &= s || r;
  ...
  public:
    ...
    CUDA_CALLABLE_MEMBER ac_fixed(const ac_fixed& op) : Base(op)
#ifdef __AC_FIXED_NUMERICAL_ANALYSIS_BASE
    ...
    template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
    CUDA_CALLABLE_MEMBER inline ac_fixed(const ac_fixed<W2, I2, S2, Q2, O2>& op) {
    ...
    CUDA_CALLABLE_MEMBER inline ac_fixed(const ac_int<W2, S2>& op) {
    ...
    template<int W2>
    CUDA_CALLABLE_MEMBER typename rt_priv<W2>::shiftl shiftl() const {
    ...
    CUDA_CALLABLE_MEMBER inline ac_fixed(bool b) { *this = (ac_int<1, false>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(char b) { *this = (ac_int<8, true>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(signed char b) { *this = (ac_int<8, true>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(unsigned char b) { *this = (ac_int<8, false>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(signed short b) { *this = (ac_int<16, true>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(unsigned short b) { *this = (ac_int<16, false>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(signed int b) { *this = (ac_int<32, true>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(unsigned int b) { *this = (ac_int<32, false>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(signed long b) { *this = (ac_int<ac_private::long_w, true>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(unsigned long b) { *this = (ac_int<ac_private::long_w, false>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(Slong b) { *this = (ac_int<64, true>) b; }
    CUDA_CALLABLE_MEMBER inline ac_fixed(Ulong b) { *this = (ac_int<64, false>) b; }

    CUDA_CALLABLE_MEMBER inline ac_fixed(double d) {
...
#pragma clang diagnostic ignored "-Wuninitialized"
    ...
    CUDA_CALLABLE_MEMBER inline ac_fixed& set_val() {
      if (V == AC_VAL_DC) {
        ac_fixed r;
        Base::operator =(r);
        bit_adjust();
...
#pragma clang diagnostic pop
    ...
    CUDA_CALLABLE_MEMBER inline ac_int<AC_MAX(I, 1), S> to_ac_int() const { return ((ac_fixed<AC_MAX(I, 1), AC_MAX(I, 1), S>) * this).template slc<AC_MAX(I, 1)>(0); }

    // Explicit conversion functions to C built-in types -------------
    CUDA_CALLABLE_MEMBER inline int to_int() const { return ((I - W) >= 32) ? 0 : (signed int)to_ac_int(); }
    CUDA_CALLABLE_MEMBER inline unsigned to_uint() const { return ((I - W) >= 32) ? 0 : (unsigned int)to_ac_int(); }
    CUDA_CALLABLE_MEMBER inline long to_long() const { return ((I - W) >= ac_private::long_w) ? 0 : (signed long)to_ac_int(); }
    CUDA_CALLABLE_MEMBER inline unsigned long to_ulong() const { return ((I - W) >= ac_private::long_w) ? 0 : (unsigned long)to_ac_int(); }
    CUDA_CALLABLE_MEMBER inline Slong to_int64() const { return ((I - W) >= 64) ? 0 : (Slong)to_ac_int(); }
    CUDA_CALLABLE_MEMBER inline Ulong to_uint64() const { return ((I - W) >= 64) ? 0 : (Ulong)to_ac_int(); }
    CUDA_CALLABLE_MEMBER inline double to_double() const { return ac_private::ldexpr<I - W>(Base::to_double()); }

    CUDA_CALLABLE_MEMBER inline int length() const { return W; }

    CUDA_CALLABLE_MEMBER inline std::string to_string(ac_base_mode base_rep, bool sign_mag = false, bool pad_to_width = false) const {
    ...
    CUDA_CALLABLE_MEMBER inline static std::string type_name() {
    ...
    // Arithmetic : Binary ----------------------------------------------------
    template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
    CUDA_CALLABLE_MEMBER typename rt<W2, I2, S2>::mult operator *(const ac_fixed<W2, I2, S2, Q2, O2>& op2) const {
      typename rt<W2, I2, S2>::mult r;
      Base::mult(op2, r);
      return r;
    }
    template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
    CUDA_CALLABLE_MEMBER typename rt<W2, I2, S2>::plus operator +(const ac_fixed<W2, I2, S2, Q2, O2>& op2) const {
      enum { F = W - I, F2 = W2 - I2 };
    ...
    template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
    CUDA_CALLABLE_MEMBER typename rt<W2, I2, S2>::minus operator -(const ac_fixed<W2, I2, S2, Q2, O2>& op2) const {
      enum { F = W - I, F2 = W2 - I2 };
...
#endif
    template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
    CUDA_CALLABLE_MEMBER typename rt<W2, I2, S2>::div operator /(const ac_fixed<W2, I2, S2, Q2, O2>& op2) const {
      typename rt<W2, I2, S2>::div r;
      enum {
        Num_w = W + AC_MAX(W2 - I2, 0), Num_i = I, Num_w_minus = Num_w + S, Num_i_minus = Num_i + S,
...
#pragma GCC diagnostic pop
    ...
    // Arithmetic assign  ------------------------------------------------------
    template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
    CUDA_CALLABLE_MEMBER ac_fixed& operator *=(const ac_fixed<W2, I2, S2, Q2, O2>& op2) {
    ...
    CUDA_CALLABLE_MEMBER ac_fixed& operator ++() {
    ...
    CUDA_CALLABLE_MEMBER const ac_fixed operator ++(int) {
      ac_fixed t = *this;
      ac_fixed<1, I - W + 1, false> q;
      q.template set_val<AC_VAL_QUANTUM>();
      operator += (q);
    ...
    // Arithmetic Unary --------------------------------------------------------
    CUDA_CALLABLE_MEMBER ac_fixed operator +() const {
      return *this;
    }
    ...
    CUDA_CALLABLE_MEMBER ac_fixed<W + !S, I + !S, true> operator ~() const {
      ac_fixed<W + !S, I + !S, true> r;
      Base::bitwise_complement(r);
      return r;
    }
    // Bitwise (not arithmetic) bit complement  -----------------------------
    CUDA_CALLABLE_MEMBER ac_fixed<W, I, false> bit_complement() const {
    ...
    template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
    CUDA_CALLABLE_MEMBER typename rt<W2, I2, S2>::logic operator &(const ac_fixed<W2, I2, S2, Q2, O2>& op2) const {
      enum { F = W - I, F2 = W2 - I2 };
    ...
    template<int W2>
    CUDA_CALLABLE_MEMBER ac_fixed operator << (const ac_int<W2, true>& op2) const {
    ...
    template<int W2>
    CUDA_CALLABLE_MEMBER ac_fixed operator << (const ac_int<W2, false>& op2) const {
    ...
    // Shift assign ------------------------------------------------------------
    template<int W2>
    CUDA_CALLABLE_MEMBER ac_fixed operator <<= (const ac_int<W2, true>& op2) {
      // currently not written to overflow or quantize (neg shift)
      Base r;
      Base::shift_l2(op2.to_int(), r);
      Base::operator=(r);
    ...
    template<int W2>
    CUDA_CALLABLE_MEMBER ac_fixed operator <<= (const ac_int<W2, false>& op2) {
      // currently not written to overflow
      Base r;
      Base::shift_l(op2.to_uint(), r);
      Base::operator=(r);
    ...
    // Relational ---------------------------------------------------------------
    template<int W2, int I2, bool S2, ac_q_mode Q2, ac_o_mode O2>
    CUDA_CALLABLE_MEMBER bool operator == (const ac_fixed<W2, I2, S2, Q2, O2>& op2) const {
      enum { F = W - I, F2 = W2 - I2 };
      if (F == F2)
    ...
    CUDA_CALLABLE_MEMBER bool operator == (double d) const {
      if (is_neg() != (d < 0.0))
        return false;
      double di = ac_private::ldexpr<-(I + !S + ((32 - W - !S) & 31))>(d);
      bool overflow, qb, r;
    ...
    CUDA_CALLABLE_MEMBER inline ac_fixed& set_slc(const ac_int<WX, SX> lsb, const ac_int<W2, S2>& slc) {
    ...
    template<int W2, bool S2>
    CUDA_CALLABLE_MEMBER inline ac_fixed& set_slc(signed lsb, const ac_int<W2, S2>& slc) {
    ...
    template<int W2, bool S2>
    CUDA_CALLABLE_MEMBER inline ac_fixed& set_slc(unsigned ulsb, const ac_int<W2, S2>& slc) {
...
# endif
      ...
      unsigned d_index;
    public:
      CUDA_CALLABLE_MEMBER ac_bitref(ac_fixed* bv, unsigned index = 0) : d_bv(*bv), d_index(index) {}
    ...
    template<int N>
    CUDA_CALLABLE_MEMBER inline void bit_fill(const int(&ivec)[N], bool bigendian = true) {
  ...
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, true, AC_TRN, AC_WRAP>::ac_fixed(bool b) { v[0] = b ? -1 : 0; }

  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(bool b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(signed char b) { v[0] = b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(unsigned char b) { v[0] = b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(signed short b) { v[0] = b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(unsigned short b) { v[0] = b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(signed int b) { v[0] = b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(unsigned int b) { v[0] = b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(signed long b) { v[0] = b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(unsigned long b) { v[0] = b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(Ulong b) { v[0] = (int)b & 1; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<1, 1, false, AC_TRN, AC_WRAP>::ac_fixed(Slong b) { v[0] = (int)b & 1; }

  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<8, 8, true, AC_TRN, AC_WRAP>::ac_fixed(bool b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<8, 8, false, AC_TRN, AC_WRAP>::ac_fixed(bool b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<8, 8, true, AC_TRN, AC_WRAP>::ac_fixed(signed char b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<8, 8, false, AC_TRN, AC_WRAP>::ac_fixed(unsigned char b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<8, 8, true, AC_TRN, AC_WRAP>::ac_fixed(unsigned char b) { v[0] = (signed char)b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<8, 8, false, AC_TRN, AC_WRAP>::ac_fixed(signed char b) { v[0] = (unsigned char)b; }

  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, true, AC_TRN, AC_WRAP>::ac_fixed(bool b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, false, AC_TRN, AC_WRAP>::ac_fixed(bool b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, true, AC_TRN, AC_WRAP>::ac_fixed(signed char b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, false, AC_TRN, AC_WRAP>::ac_fixed(unsigned char b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, true, AC_TRN, AC_WRAP>::ac_fixed(unsigned char b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, false, AC_TRN, AC_WRAP>::ac_fixed(signed char b) { v[0] = (unsigned short)b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, true, AC_TRN, AC_WRAP>::ac_fixed(signed short b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, false, AC_TRN, AC_WRAP>::ac_fixed(unsigned short b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, true, AC_TRN, AC_WRAP>::ac_fixed(unsigned short b) { v[0] = (signed short)b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<16, 16, false, AC_TRN, AC_WRAP>::ac_fixed(signed short b) { v[0] = (unsigned short)b; }

  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<32, 32, true, AC_TRN, AC_WRAP>::ac_fixed(signed int b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<32, 32, true, AC_TRN, AC_WRAP>::ac_fixed(unsigned int b) { v[0] = b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<32, 32, false, AC_TRN, AC_WRAP>::ac_fixed(signed int b) { v[0] = b; v[1] = 0; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<32, 32, false, AC_TRN, AC_WRAP>::ac_fixed(unsigned int b) { v[0] = b; v[1] = 0; }

  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<32, 32, true, AC_TRN, AC_WRAP>::ac_fixed(Slong b) { v[0] = (int)b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<32, 32, true, AC_TRN, AC_WRAP>::ac_fixed(Ulong b) { v[0] = (int)b; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<32, 32, false, AC_TRN, AC_WRAP>::ac_fixed(Slong b) { v[0] = (int)b; v[1] = 0; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<32, 32, false, AC_TRN, AC_WRAP>::ac_fixed(Ulong b) { v[0] = (int)b; v[1] = 0; }

  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<64, 64, true, AC_TRN, AC_WRAP>::ac_fixed(Slong b) { v[0] = (int)b; v[1] = (int)(b >> 32); }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<64, 64, true, AC_TRN, AC_WRAP>::ac_fixed(Ulong b) { v[0] = (int)b; v[1] = (int)(b >> 32); }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<64, 64, false, AC_TRN, AC_WRAP>::ac_fixed(Slong b) { v[0] = (int)b; v[1] = (int)((Ulong)b >> 32); v[2] = 0; }
  template<> CUDA_CALLABLE_MEMBER inline ac_fixed<64, 64, false, AC_TRN, AC_WRAP>::ac_fixed(Ulong b) { v[0] = (int)b; v[1] = (int)(b >> 32); v[2] = 0; }
...
#define FX_BIN_OP_WITH_INT_2I(BIN_OP, C_TYPE, WI, SI)  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O> \
  CUDA_CALLABLE_MEMBER inline ac_fixed<W,I,S,Q,O> operator BIN_OP ( const ac_fixed<W,I,S,Q,O> &op, C_TYPE i_op) {  \
    return op.operator BIN_OP (ac_int<WI,SI>(i_op));  \
  }

#define FX_BIN_OP_WITH_INT(BIN_OP, C_TYPE, WI, SI, RTYPE)  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O> \
  CUDA_CALLABLE_MEMBER inline typename ac_fixed<WI,WI,SI>::template rt<W,I,S>::RTYPE operator BIN_OP ( C_TYPE i_op, const ac_fixed<W,I,S,Q,O> &op) {  \
    return ac_fixed<WI,WI,SI>(i_op).operator BIN_OP (op);  \
  } \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O> \
  CUDA_CALLABLE_MEMBER inline typename ac_fixed<W,I,S>::template rt<WI,WI,SI>::RTYPE operator BIN_OP ( const ac_fixed<W,I,S,Q,O> &op, C_TYPE i_op) {  \
    return op.operator BIN_OP (ac_fixed<WI,WI,SI>(i_op));  \
  }

#define FX_REL_OP_WITH_INT(REL_OP, C_TYPE, W2, S2)  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O> \
  CUDA_CALLABLE_MEMBER inline bool operator REL_OP ( const ac_fixed<W,I,S,Q,O> &op, C_TYPE op2) {  \
    return op.operator REL_OP (ac_fixed<W2,W2,S2>(op2));  \
  }  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O> \
  CUDA_CALLABLE_MEMBER inline bool operator REL_OP ( C_TYPE op2, const ac_fixed<W,I,S,Q,O> &op) {  \
    return ac_fixed<W2,W2,S2>(op2).operator REL_OP (op);  \
  }

#define FX_ASSIGN_OP_WITH_INT_2(ASSIGN_OP, C_TYPE, W2, S2)  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O> \
  CUDA_CALLABLE_MEMBER inline ac_fixed<W,I,S,Q,O> &operator ASSIGN_OP ( ac_fixed<W,I,S,Q,O> &op, C_TYPE op2) {  \
    return op.operator ASSIGN_OP (ac_fixed<W2,W2,S2>(op2));  \
  }

#define FX_ASSIGN_OP_WITH_INT_2I(ASSIGN_OP, C_TYPE, W2, S2)  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O> \
  CUDA_CALLABLE_MEMBER inline ac_fixed<W,I,S> operator ASSIGN_OP ( ac_fixed<W,I,S,Q,O> &op, C_TYPE op2) {  \
...
#define FX_BIN_OP_WITH_AC_INT_1(BIN_OP, RTYPE)  \
  ...
  CUDA_CALLABLE_MEMBER inline typename ac_fixed<WI,WI,SI>::template rt<W,I,S>::RTYPE operator BIN_OP ( const ac_int<WI,SI> &i_op, const ac_fixed<W,I,S,Q,O> &op) {  \
    return ac_fixed<WI,WI,SI>(i_op).operator BIN_OP (op);  \
  }

#define FX_BIN_OP_WITH_AC_INT_2(BIN_OP, RTYPE)  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O, int WI, bool SI> \
  CUDA_CALLABLE_MEMBER inline typename ac_fixed<W,I,S>::template rt<WI,WI,SI>::RTYPE operator BIN_OP ( const ac_fixed<W,I,S,Q,O> &op, const ac_int<WI,SI> &i_op) {  \
    return op.operator BIN_OP (ac_fixed<WI,WI,SI>(i_op));  \
  }
...
#define FX_REL_OP_WITH_AC_INT(REL_OP)  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O, int WI, bool SI> \
  CUDA_CALLABLE_MEMBER inline bool operator REL_OP ( const ac_fixed<W,I,S,Q,O> &op, const ac_int<WI,SI> &op2) {  \
    return op.operator REL_OP (ac_fixed<WI,WI,SI>(op2));  \
  }  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O, int WI, bool SI> \
  CUDA_CALLABLE_MEMBER inline bool operator REL_OP ( ac_int<WI,SI> &op2, const ac_fixed<W,I,S,Q,O> &op) {  \
    return ac_fixed<WI,WI,SI>(op2).operator REL_OP (op);  \
  }

#define FX_ASSIGN_OP_WITH_AC_INT(ASSIGN_OP)  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O, int WI, bool SI> \
  CUDA_CALLABLE_MEMBER inline ac_fixed<W,I,S,Q,O> &operator ASSIGN_OP ( ac_fixed<W,I,S,Q,O> &op, const ac_int<WI,SI> &op2) {  \
    return op.operator ASSIGN_OP (ac_fixed<WI,WI,SI>(op2));  \
  }  \
  template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O, int WI, bool SI> \
  CUDA_CALLABLE_MEMBER inline ac_int<WI,SI> &operator ASSIGN_OP ( ac_int<WI,SI> &op, const ac_fixed<W,I,S,Q,O> &op2) {  \
  ...
  namespace ac {
    namespace ops_with_other_types {
      ...
      FX_BIN_OP_WITH_AC_INT(*, mult)
        ...
        template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O>
      CUDA_CALLABLE_MEMBER inline bool operator == (double op, const ac_fixed<W, I, S, Q, O>& op2) {
...
#pragma clang diagnostic ignored "-Wuninitialized"
  ...
  namespace ac {
    ...
    template<ac_special_val V, int W, int I, bool S, ac_q_mode Q, ac_o_mode O>
    CUDA_CALLABLE_MEMBER inline bool init_array(ac_fixed<W, I, S, Q, O>* a, int n) {
      ac_fixed<W, I, S> t;
    ...
    CUDA_CALLABLE_MEMBER inline ac_fixed<54, 2, true> frexp_d(double d, ac_int<11, true>& exp) {
    ...
    CUDA_CALLABLE_MEMBER inline ac_fixed<53, 1, false> frexp_sm_d(double d, ac_int<11, true>& exp, bool& sign) {
      enum { Min_Exp = -1022, Max_Exp = 1023, Mant_W = 52, Denorm_Min_Exp = Min_Exp - Mant_W };
      if (!d) {
        exp = 0;
        sign = false;
    ...
    template<int W, int I, bool S, ac_q_mode Q, ac_o_mode O>
    CUDA_CALLABLE_MEMBER const ac_fixed<W, I, S, Q, O>& basic_num_ovf_base<W, I, S, Q, O>::value() const {
